...
class Game:
    ...
    def draw(self):
        ...
        if self.stopped:
            ...
            self.screen.blit(pause_text, (380, 374))
        else:
            self.track_bombs()
...
class Menu:
    ...
    def load_buttons(self):
        self.button_start = Button(self.screen, "START", 350, 240, 140, 50, 25, 15, 2)
        self.button_instructions = Button(self.screen, "INSTRUCTIONS", 310, 320, 230, 50, 10, 15, 2)
        self.button_high_score = Button(self.screen, "HIGH SCORE", 325, 400, 200, 50, 10, 15, 2)
        self.button_quit = Button(self.screen, "QUIT", 350, 480, 140, 50, 35, 15, 2)
        self.input = Input(self.screen, "", 325, 150, 190, 50, 20, 15, 2, 11)
